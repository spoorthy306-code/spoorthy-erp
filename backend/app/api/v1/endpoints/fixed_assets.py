...
from ....models.models import FixedAssetSchema, FixedAssetCreateSchema, FixedAsset

router = APIRouter()

@router.post("/", response_model=FixedAssetSchema, status_code=201)
async def create_fixed_asset(
    asset: FixedAssetCreateSchema,
...
async def run_depreciation(
    ...
    return {"asset_id": str(asset_id), "annual_depreciation": annual_depr, "accumulated": new_accum, "nbv": new_nbv}
