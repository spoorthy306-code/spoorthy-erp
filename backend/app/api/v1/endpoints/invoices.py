...
from ....models.models import InvoiceCreateSchema, InvoiceSchema
...
async def create_invoice(
    invoice: InvoiceCreateSchema, db: AsyncSession = Depends(get_db)
):
...
async def generate_irn(invoice_id: UUID, db: AsyncSession = Depends(get_db)):
