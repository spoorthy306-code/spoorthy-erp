...
from ....models.models import GSTReturnSchema, GSTReturnCreateSchema, GSTReturn

router = APIRouter()

@router.post("/", response_model=GSTReturnSchema, status_code=201)
async def create_gst_return(
    gst_return: GSTReturnCreateSchema,
...
async def file_gst_return(
    ...
    result = await db.execute(
        update(GSTReturn).where(GSTReturn.return_id == return_id)
