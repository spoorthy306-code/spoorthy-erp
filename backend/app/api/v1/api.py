...
from .endpoints import (
    entities, chart_of_accounts, journal_entries, bank_transactions,
    invoices, fixed_assets, inventory, employees, payroll,
    loans, portfolios, quantum_jobs, gst_returns, reports,
    compliance, admin, revenue, treasury, credit
)
...
# Quantum & Compliance
api_router.include_router(quantum_jobs.router,      prefix="/quantum-jobs",      tags=["quantum-jobs"])
api_router.include_router(gst_returns.router,       prefix="/gst-returns",       tags=["gst-returns"])
...
api_router.include_router(quantum_jobs.router,      prefix="/reconciliation",    tags=["reconciliation"])
# /financial-statements → reports
api_router.include_router(reports.router,           prefix="/financial-statements", tags=["financial-statements"])
