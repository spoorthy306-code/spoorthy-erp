...
class AccountGroup(Base):
    ...
    group_type = Column(String(50), nullable=False)  # asset, liability, income, expense, equity
...
class Party(Base):
    ...
    # Relationships
    invoices = relationship("Invoice", back_populates="party", foreign_keys="Invoice.party_id")
...
class Invoice(Base):
    ...
    status = Column(String(20), default="draft")  # draft, sent, paid, overdue, written_off
    created_at = Column(DateTime, default=datetime.utcnow)
