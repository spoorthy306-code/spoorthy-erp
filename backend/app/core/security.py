...
if not SECRET_KEY:
   SECRET_KEY = os.environ.get("SECRET_KEY", "dev-only-insecure-default-change-in-prod")
ALGORITHM = "HS256"
...
def verify_pqc_signature(data: bytes, signature: str, public_key_pem: Optional[str] = None) -> bool:
