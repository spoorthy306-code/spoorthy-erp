...
class TaxComplianceEngine:
    ...
    async def generate_tds_statement(self, entity_id: str, quarter: str) -> Dict[str, Any]:
    ...
    async def generate_itr(self, entity_id: str, assessment_year: str) -> Dict[str, Any]:
...
class RegulatoryReportingEngine:
    ...
    async def generate_sebi_reports(self, entity_id: str, period: str) -> Dict[str, Any]:
