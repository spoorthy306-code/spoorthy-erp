...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_account_groups_code"), "account_groups", ["code"], unique=True
    )
    op.create_table(
        "audit_trail",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_audit_trail_entry_uid"), "audit_trail", ["entry_uid"], unique=True
    )
    op.create_table(
        "budgets",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "eway_bill_threshold", sa.Numeric(precision=18, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_exchange_rates_from_currency"),
        "exchange_rates",
        ["from_currency"],
        unique=False,
    )
    op.create_index(
        op.f("ix_exchange_rates_to_currency"),
        "exchange_rates",
        ["to_currency"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_employees_emp_code"), "employees", ["emp_code"], unique=True
    )
    op.create_table(
        "ledgers",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "disposal_proceeds", sa.Numeric(precision=18, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_fixed_assets_asset_code"), "fixed_assets", ["asset_code"], unique=True
    )
    op.create_table(
        "leave_requests",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "idx_voucher_date_type",
        "vouchers",
        ["voucher_date", "voucher_type_id"],
        unique=False,
    )
    op.create_index("idx_voucher_fy", "vouchers", ["fiscal_year"], unique=False)
    op.create_index(
        op.f("ix_vouchers_voucher_date"), "vouchers", ["voucher_date"], unique=False
    )
    op.create_index(
        op.f("ix_vouchers_voucher_no"), "vouchers", ["voucher_no"], unique=True
    )
    op.create_table(
        ...
        sa.Column(
            "statement_balance", sa.Numeric(precision=18, scale=2), nullable=False
        ),
        sa.Column("book_balance", sa.Numeric(precision=18, scale=2), nullable=False),
        sa.Column(
            "uncleared_deposits", sa.Numeric(precision=18, scale=2), nullable=True
        ),
        sa.Column(
            "uncleared_payments", sa.Numeric(precision=18, scale=2), nullable=True
        ),
        sa.Column("bank_charges", sa.Numeric(precision=18, scale=2), nullable=True),
        sa.Column(
            "interest_credited", sa.Numeric(precision=18, scale=2), nullable=True
        ),
        sa.Column(
            "adjusted_bank_balance", sa.Numeric(precision=18, scale=2), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_transactions_ledger_id"), "transactions", ["ledger_id"], unique=False
    )
    op.create_index(
        op.f("ix_transactions_voucher_id"), "transactions", ["voucher_id"], unique=False
    )
    op.create_table(
        "voucher_line_items",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_voucher_line_items_voucher_id"),
        "voucher_line_items",
        ["voucher_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_voucher_line_items_voucher_id"), table_name="voucher_line_items"
    )
